...
- If you store figures elsewhere, update the paths below.

![S0 treated vs synthetic](figures/S0_treated_vs_synth.png)

**Figure 2.** Gap (treated − synthetic), baseline timing (S0).

![S0 gap](figures/S0_gap.png)
...
![S0 placebo ratios](figures/S0_placebo_ratio_dist.png)
...
If you want to show these numbers in the repo, you can link the CSV generated by the notebook (e.g., `tables/all_specs_summary_extended.csv`).
...
![N0 treated vs synthetic](figures/N0_treated_vs_synth.png)

**Figure 5.** Gap (violent), baseline timing (N0).

![N0 gap](figures/N0_gap.png)
