...
![S0 gap](output/figures/S0_gap.png)
...
![S0 placebo ratios](output/figures/S0_placebo_ratio_dist.png)
...
![N0 treated vs synthetic](output/figures/N0_treated_vs_synth.png)

**Figure 5.** Gap (violent), baseline timing (N0).

![N0 gap](output/figures/N0_gap.png)
